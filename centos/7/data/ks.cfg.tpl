...
network --bootproto=static --device=link --interfacename=ens192 --activate  --onboot=yes --ip=${ split("/", address)[0] } --netmask=255.255.255.192 --gateway=${ gateway } --nameserver=${ dns_servers } --hostname=${ hostname }
%{ endfor ~}
